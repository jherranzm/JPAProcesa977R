...
/**
 * The persistent class for the tbl_escenario_cond_trafico database table.
 * 
 */
@Entity
@Table(name="tbl_escenario_cond_trafico")
public class TblEscenarioCondTrafico implements Serializable {
    ...
    public TblEscenarioCondTrafico() {
    }
