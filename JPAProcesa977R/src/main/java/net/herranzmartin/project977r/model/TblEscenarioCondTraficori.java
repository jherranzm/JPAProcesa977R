...
/**
 * The persistent class for the tbl_escenario_cond_traficori database table.
 * 
 */
@Entity
@Table(name="tbl_escenario_cond_traficori")
public class TblEscenarioCondTraficori implements Serializable {
    ...
    public TblEscenarioCondTraficori() {
    }
